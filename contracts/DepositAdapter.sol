...
contract DepositAdapter is AdapterBase {
     ...
     */
    function initialize(bytes memory adapterInitData, address, bytes memory) external initializer {
        __AdapterBase_init(adapterInitData);

        _name = string.concat("VaultCraft ", IERC20Metadata(asset()).name(), " Adapter");
